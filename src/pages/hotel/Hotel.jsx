...
const Hotel = () => {
  ...
  const { data, loading, error } = useFetch(`http://localhost:8800/api/hotels/${hotelId}`);
  ...
  const nights = dayDifference(dates[0].endDate, dates[0].startDate);
      ...
      <div className="hotelContainer">
        ...
        {loading ? (
          ...
          <div className="hotelWrapper">
            <button className="bookNow" onClick={modalHandler}>
              Reserve or Book Now!
            </button>
            ...
            <span className="hotelPriceHighlight">Book a stay over ${hotel?.cheapestPrice} at this property and get a free airport taxi</span>
            ...
            <div className="hotelDetails">
              ...
              <div className="hotelDetailsPrice">
                ...
                <button onClick={modalHandler}>Reserve or Book Now!</button>
              </div>
            </div>
          </div>
        )}
