...
const Header = ({ type }) => {
  ...
  const handleSearch = () => {
    dispatch({ type: 'NEW_SEARCH', payload: { city: destination, dates: date, options: options } });
      ...
      <div className={type === 'list' ? 'headerContainer listMode' : 'headerContainer'}>
        ...
        {type !== 'list' && (
          <>
            ...
            <p className="headerDesc">Get rewarded for your travels – unlock instant savings of 10% or more with a free Ngendong Kuy! account</p>
