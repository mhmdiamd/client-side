...
const PropertyList = () => {
  const { data, loading, error } = useFetch('http://localhost:8800/api/hotels/find/countByType?type=Hotel,apartements, resorts, villas,cabins');
  const images = [
